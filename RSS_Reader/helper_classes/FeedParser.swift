...
class FeedParser {
    ...
    private func parseArticle(_ article_str: String) -> ArticleData? {
        ...
        return ArticleData(article_id: art_data!.guid, title: art_data!.title, description: art_data!.description, link: art_data!.link, pub_date: art_pub_date!, author: nil, parent_feeds: [],parent_feeds_ids:[])
    }
